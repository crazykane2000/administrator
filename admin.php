...
<head>
    ...
    <title>Add Backoffice Administrator | Bingo</title>
  ...
  <body>
    ...
    <div class="o-page">
     <?php include 'header.php'; ?>
      <div class="container" style="padding-left:40px;min-height: 700px">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <h4>Add Backoffice Administrator</h4>
            <p class="u-mb-small">Administrator Sections</p>
           <form action="add_admin_handle.php" method="POST">
              <div class="">
             
              
              <div class="c-card" style="min-height: 700px">
                 <h4>Add Backoffice Administrator</h4>
                 <hr style="margin: 10px 0px;opacity: .2" />
                <div class="row">
                   <div class="col-lg-3">
                     <div class="c-field">
                      <label class="c-field__label" for="input1">Administrator Type</label>
                      <select class="c-input" type="text" id="input1" name="business_partner_type" >
                        <?php 
                            $fata = fetch_all_popo("admin_roles");
                            foreach ($fata as $key => $value) {
                              echo '<option>'.$value['admin_role'].'</option>';
                            }
                         ?>
                      </select>
                      <!-- <select class="c-input" type="text" id="input1" name="business_partner_type" >
                 ...
                 <div style="padding: 10px;"></div>
                   ...
                   <div class="row">
                     ...
                     <div class="col-lg-4">
                       <div class="c-field">
                        <label class="c-field__label" for="input1">User Name </label>
                        <input class="c-input" type="email" id="input1" name="admin_username" placeholder="Username : email Required">
                      </div>
                     </div>
                     ...
                     <div class="col-lg-4">
                       <div class="c-field">
                        ...
                        <input class="c-input" type="text" id="input1" name="password" placeholder="Password Here" value="<?php echo uniqid(); ?>">
                      </div>
                     </div>
                 ...
                 <div class="row">
                    <div class="col-sm-6">
                      <div style="padding: 10px;"></div>
                      <button class="c-btn c-btn--info ">Add New Admin Member</button>
                    </div>
