...
<head>
    ...
    <title>View All FIE | Bingo</title>
      ...
      <div class="container-fluid" style="padding-left:40px;">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <h4>View all FIE (Financial Institution)</h4>
            <p class="u-mb-small">Administrator Sections</p>
            <div class="">
             
              
              <div class="c-card">
                 <h4>FIE (Financial Institution)</h4>
                 ...
                 <table class="tabler">
                     ...
                     <tbody>
                      ...
                      <?php 
                        $i=1;
                        try {
                              $stmt = $pdo->prepare('SELECT * FROM `business_partners` WHERE `partner_type`="FIE" ORDER BY creation_date DESC');
                              ...
                              foreach ($user as $key => $value) {
                               ...
                               // print_r($value);
                                echo '<tr>
                                       <td>'.$i.'.</td>
                                       <td data-id="'.$value['id'].'"  style="font-weight: bold;color:#333;cursor:pointer" class="tango" data-toggle="modal" data-target="#modal1"><b>'.$value['name'].'</b></td>
                                       <td>'.$status.'</td>
                                       <td >'.$value['address'].'</td>
                                       <td>0</td>
                                       <td>0</td>
